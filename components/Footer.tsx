  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        <p className="text-center font-mono-jet text-[10px] text-[#2E4560] mb-6 tracking-wide">
          RULE 07 <span className="text-[#1E3050]">·</span> DENY ANY <span aria-hidden="true">→</span> ANY{" "}
          <span className="text-[#00FF88]/70">[LOG]</span>
          <span className="mx-2 text-[#1E3050]">//</span> end of ruleset
        </p>
